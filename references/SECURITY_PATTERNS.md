...
|---|---|---|
| SP-001 | [BLOCKED] RED | Prompt injection in skill description |
| SP-002 | [BLOCKED] RED | Unguarded subprocess execution |
| SP-003 | [BLOCKED] RED | Hidden Unicode direction override |
| SP-004 | [BLOCKED] RED | Zero-width character obfuscation |
| SP-005 | [BLOCKED] RED | Embedded API key or secret token |
| SP-006 | [REVIEW] YELLOW | Unguarded `eval()` or `exec()` |
| SP-007 | [REVIEW] YELLOW | Environment variable exfiltration attempt |
| SP-008 | [REVIEW] YELLOW | Homoglyph substitution in code |
| SP-009 | [BLOCKED] RED | Instruction override attempt ("ignore previous instructions") |
| SP-010 | [REVIEW] YELLOW | Outbound network call from skill script (unexpected) |
