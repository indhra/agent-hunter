...
Commands:
    hunt [project_root]     — Discover top 3 skills/MCPs for your project.
...
Error handling (per SPEC.md §13):
    ...
    - Zero results → suggest check tech stack, non-zero exit
...
def cmd_hunt(args: list[str]) -> int:
    ...
    Flags:
        ...
        --no-github      Force-skip GitHub Tier 2 search (use curated index only).
...
Learn more: https://github.com/indhra/agent-hunter
"""
